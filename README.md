...
![PICKLE기능설명](https://github.com/user-attachments/assets/2c45e49c-2f29-43bd-8d86-0b6480187233)
...
### 7. 해커톤 참여 후기
- 이번 해커톤을 통해 평소 상상으로만 했던 서비스를 구현해서 뿌듯하였습니다.
- 프론트로서 백엔드 API 설계에 대한 소통을 하며 개발의 지식을 확장할 수 있었습니다.
<br/>
